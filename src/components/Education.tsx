	...
	return (
		<>
			...
			<p>
				...
				decided to learn japanese on my own. Partly because of japanese
				literature and music, partly because of anime I must confess. While
				learning japanese I came into contact with software that I found amazing
				like Anki and Migaku. First, I started changing the background color and
				the font of a page. Then, running Python scripts (made by someone else
				of course) to convert digital japanese dictionaries. By then I already
				felt like a complete hacker (little did I know...)
			</p>
			<p>
			...
			<p>
				...
				CSS3, and much more. From the first step designing in Figma, to version
				control with Git and GitHub, and finally deploying to a cloud platform
